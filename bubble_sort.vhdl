...
66 => "01110010",  -- STORE L, 71 (SMC: Schreibe Ausgabe-Index in Low-Byte von LOAD A)
67 => "00000000",  -- (Zubyte: High-Byte Ziel 71)
68 => "01000111",  -- (Zubyte: Low-Byte Ziel 71)
...
74 => "11110000",  -- ALU COMP, L, E, 111 (Prüfe, ob der gedruckte Index L == E ist, also 7)
75 => "00110100",  -- (Zubyte 1: Quell-L="110", E="100") 
76 => "00000111",  -- (Zubyte 2: Ziel="111") 
77 => "11000110",  -- JCC Z, 64 (Wenn L == 7, wurde arr[7] erfolgreich ausgegeben -> Reset bei 64)
78 => "00000000",  -- (Zubyte: High-Byte Ziel 64)
79 => "01000000",  -- (Zubyte: Low-Byte Ziel 64)
80 => "01110000",  -- INR L (Nächsten Index vorbereiten)

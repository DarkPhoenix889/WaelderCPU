...
REM
REM Generated by Vivado on Fri Feb 06 13:58:22 +0100 2026
...
echo "xvhdl --incr --relax -prj waelderPC_tb_vhdl.prj"
call xvhdl  --incr --relax -prj waelderPC_tb_vhdl.prj -log xvhdl.log

...
REM
REM Generated by Vivado on Tue Mar 24 22:07:37 +0100 2026
...
echo "xvhdl --incr --relax -prj waelderCU_tb_vhdl.prj"
call xvhdl  --incr --relax -prj waelderCU_tb_vhdl.prj -log xvhdl.log

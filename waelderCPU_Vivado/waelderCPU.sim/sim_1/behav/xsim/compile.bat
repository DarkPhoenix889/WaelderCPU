...
REM
REM Generated by Vivado on Wed Dec 31 11:24:05 +0100 2025
...
echo "xvhdl --incr --relax -prj waelderMain_tb_vhdl.prj"
call xvhdl  --incr --relax -prj waelderMain_tb_vhdl.prj -log xvhdl.log

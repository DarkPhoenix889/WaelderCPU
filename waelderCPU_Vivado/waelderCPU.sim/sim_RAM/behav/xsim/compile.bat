...
REM
REM Generated by Vivado on Thu Feb 12 11:37:44 +0100 2026
...
echo "xvhdl --incr --relax -prj waelderRAM_tb_vhdl.prj"
call xvhdl  --incr --relax -prj waelderRAM_tb_vhdl.prj -log xvhdl.log
